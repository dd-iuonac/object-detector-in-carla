...
def create_kitti_info_file(data_path,
                           ...
                           relative_path=True):
    train_img_ids = _read_imageset_file("data/ImageSetss/train.txt")
    val_img_ids = _read_imageset_file("data/ImageSetss/val.txt")
    trainval_img_ids = _read_imageset_file("data/ImageSetss/trainval.txt")
    test_img_ids = _read_imageset_file("data/ImageSetss/test.txt")
