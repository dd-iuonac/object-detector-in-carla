...
from dddssd.lib.utils.collections import AttrDict
...
__C.DATASET.TYPE = 'CARLA' # KITTI, NuScenes, Lyft
...
__C.DATASET.KITTI.BASE_DIR_PATH = 'dataset/CARLA/object'

__C.DATASET.KITTI.TRAINVAL_LIST = 'dataset/CARLA/object/trainval.txt'

__C.DATASET.KITTI.TRAIN_LIST = 'dataset/CARLA/object/train.txt'

__C.DATASET.KITTI.VAL_LIST = 'dataset/CARLA/object/val.txt'

__C.DATASET.KITTI.TEST_LIST = 'dataset/CARLA/object/test.txt'

__C.DATASET.KITTI.SAVE_NUMPY_PATH = 'data/CARLA'
