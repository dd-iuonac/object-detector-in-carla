...
def box_3d_collision_test(boxes, q_boxes, classes, q_classes, boxes_points, points, sem_labels, sem_dists, plane,
                          enlarge_range=[0.5, 2.0, 0.5]):
...
def box_3d_collision_test_nusc(boxes, q_boxes, classes, q_classes, boxes_points, boxes_attributes, boxes_velocity,
                               points, attributes=None, velocity=None, cur_sweep_points_num=None,
                               enlarge_range=[0.5, 2.0, 0.5]):
    """ Calculate whether two boxes are collided
        Args:
            boxes: [n, 7], x, y, z, l, h, w, ry, generate boxes
