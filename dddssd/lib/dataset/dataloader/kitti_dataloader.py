...
import dddssd.lib.utils.kitti_object as kitti_object
import dddssd.lib.utils.box_3d_utils as box_3d_utils
...
from dddssd.lib.utils.points_filter import *
...
from dddssd.lib.utils.tf_ops.evaluation.tf_evaluate import evaluate, calc_iou
...
class KittiDataset(Dataset):
    ...
    """
    def __init__(self, mode, split='testing', img_list='train', is_training=True, workers_num=1):
        """
        ...
        if mode == 'loading':
            ...
            if self.is_training:
                self.data_augmentor = DataAugmentor(str(cfg.DATASET.TYPE), workers_num=self.workers_num)
