...
import dddssd.lib.utils.generate_anchors as generate_anchors
from dddssd.lib.utils.model_util import g_type_mean_size
...
class Anchors:
    def __init__(self, stage, class_list):
        ...
        if cfg.DATASET.TYPE == 'KITTI' or cfg.DATASET.TYPE == 'CARLA':
            prefix = 'Kitti'
